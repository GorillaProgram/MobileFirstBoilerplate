...
public class HybridBoilerplate extends CordovaActivity implements
	...
	/**
	 * The IBM MobileFirst Platform calls this method after its initialization
	 * is complete and web resources are ready to be used.
	 */
